...
def sequence_summary(sequence_dictionary, outfile):
	...
	for header in sequence_dictionary:
		...
		seq_stat = header+"\t"+str(freq_Adenine)+"\t"+str(freq_Cytosine)+"\t"+str(freq_Guanine)+"\t"+str(freq_Thymine)+"\t"+str(length)+"\t"+str(round(ratio_purine,8))+"\t"+str(round(ratio_pyrimidine,8))+"\n"
	...
	total_seq_stats = str(total_assembly_stat[0])+"\t"+str(total_assembly_stat[1])+"\t"+str(total_assembly_stat[2])+"\t"+str(total_assembly_stat[3])+"\t"+str(total_assembly_stat[4])+"\t"+str(round(total_ratio_purine,8))+"\t"+str(round(total_ratio_pyrimidine,8))+"\n"
