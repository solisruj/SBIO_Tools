...
def create_parser():
	parser = argparse.ArgumentParser(description="This outputs a simple reggression plot for a a given tab deliminated data text file.")
...
def main():
	...
	simple_regression = sns.jointplot(x=dataframe[factors[0]], y=dataframe[factors[1]], kind="reg")

	simple_regression.savefig(output_file)
